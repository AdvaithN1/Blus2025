...
function addToastWithLink(title, message, link) {
    ...
    toast.innerHTML = `
        ...
        <div class="toast-body">
            ${message}
            <a href="${link}" class="btn btn-primary btn-sm">View Documents</a>
            <br>
            <a id="displaySentImageBtn" onclick="addBase64ImageToWhiteboard('${link}'); this.parentElement.parentElement.remove()" class="btn btn-primary btn-sm">Edit Document</a>
        </div>
    `;
...
function addToastWithPic(title, message, link) {
    // Select the toast container
    let toastContainer = document.getElementById("add-toasts-here");
